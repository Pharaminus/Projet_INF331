...
import com.studor.orientation_student.manager.repositories.profilejobpredictrepository.ProfilRepository;
...
public class ObjectifController {
    ...
    public String saveObjectif(HttpSession session, @ModelAttribute("objectif") ObjectifUtilisateur objectifUtilisateur){
        ...
        if(user == null ){
            ...
            Profil profil = userRepository.findByEmail(user.getEmail()).getProfil(); // on recupere en base de donnee
            ...
            if(objectifUtilisateur1 != null ){
                ...
                profil.setObjectifUtilisateur(objectifUtilisateur); // on met a jour les informations de la table utilisateur
            }
